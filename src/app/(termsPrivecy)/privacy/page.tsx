  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <section className="mb-6">
        ...
        <div className="mt-4">
          <h2 className="mb-1 text-lg font-semibold">Personal Data</h2>
          <p>
        ...
        <div className="mt-4">
          <h2 className="mb-1 text-lg font-semibold">Derivative Data</h2>
          <p>
        ...
        <div className="mt-4">
          <h2 className="mb-1 text-lg font-semibold">Financial Data</h2>
          <p>
            ...
            processor, [payment processor- add- like sslcommerce / FSI Bank],
        ...
        <div className="mt-4">
          ...
          <p>
            ...
            site], including your name, your social network username, location,
            gender, birth date, email address, profile picture, and public data
            for contacts, if you connect your account to such social networks.
          </p>
        </div>

        <div className="mt-4">
          <h2 className="mb-1 text-lg font-semibold">Mobile Device Data</h2>
          <p>
        ...
        <div className="mt-4">
          <h2 className="mb-1 text-lg font-semibold">Third-Party Data</h2>
          <p>
      ...
      <section className="mb-2 mt-3">
        <h2 className="mb-1 text-2xl font-semibold">Use of Your Information</h2>
        <p>
        ...
        <ol className="ml-4 mt-3 list-inside list-disc">
          ...
          <li>
            Personalize and improve the Site and provide advertisements,
      ...
      <section className="mb-2 mt-6">
        ...
        <div className="mb-3 mt-2">
          <h2 className="mb-1 text-lg font-semibold">Business Transfers</h2>
          <p>
        ...
        <div className="mb-3 mt-2">
          <h2 className="mb-1 text-lg font-semibold">Affiliates</h2>
          <p>
        ...
        <div className="mb-3 mt-2">
          <h2 className="mb-1 text-lg font-semibold">Business Partners</h2>
          <p>
        ...
        <div className="mb-3 mt-2">
          <h2 className="mb-1 text-lg font-semibold">Other Third Parties</h2>
          <p>
        ...
        <div className="mb-3 mt-2">
          <h2 className="mb-1 text-lg font-semibold">Sale or Bankruptcy</h2>
          <p>
            ...
            occur and that the transferee may decline to honor commitments we
      ...
      <section className="mb-2 mt-6">
        <h2 className="mb-1 text-2xl font-semibold">Tracking Technologies</h2>
        <div className="mb-3 mt-2">
          <h2 className="mb-1 text-lg font-semibold">
          ...
          <p>
            ...
            and functionality of the Site. You may not decline web beacons.
        ...
        <div className="mb-3 mt-2">
          ...
          <p>
            ...
            your online experience with us. For more information about opting
            out of interest-based ads, visit the Network Advertising Initiative
            Opt-Out Tool or Digital Advertising Alliance Opt-Out Tool.
          </p>
        </div>

        <div className="mb-3 mt-2">
          <h2 className="mb-1 text-lg font-semibold">Website Analytics</h2>
          <p>
            ...
            track users’ use of the Site, determine the popularity of certain
            ...
            third-party vendors. However, if you do not want any information to
            be collected and used by tracking technologies, you can visit the
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-2xl font-semibold">Policy for Children</h2>
        <p className="mb-2">
      ...
      <section className="mb-6">
        ...
        <div className="mt-4">
          ...
          <ol className="mb-2 ml-4 mt-3 list-inside list-disc">
            <li>
