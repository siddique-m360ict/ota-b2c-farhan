...
const data = [
  ...
  },
  {
    ...
    img: "/images/home/routes/international/colombo.jpg",
    formDate: addDays(new Date(), 15),
    toDate: addDays(new Date(), 24),
  },
  {
    ...
    img: "/images/home/routes/international/Delhi.jpg",
    formDate: addDays(new Date(), 15),
    toDate: addDays(new Date(), 24),
  },

  {
    ...
    img: "/images/home/routes/international/Bangkok.jpg",
    formDate: addDays(new Date(), 15),
    toDate: addDays(new Date(), 24),
  },
  {
    ...
    to: {
      ...
      country_id: 99,
      country: "INDIA",
      name: "Calcutta (Kolkata) - Netaji Subhas Chandra",
      iata_code: "CCU",
      city: "Kolkata",
    },
    img: "/images/home/routes/international/Kolkata.jpg",
    formDate: addDays(new Date(), 15),
    toDate: addDays(new Date(), 24),
  },
  {
    ...
    img: "/images/home/routes/international/Bangalore.jpg",
    formDate: addDays(new Date(), 15),
    toDate: addDays(new Date(), 24),
  },
]
