        ...
        <CardContent>
          <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
            ...
            <div className="mt-2 grid gap-1">
              ...
              <RadioGroup
                defaultValue={gender}
                className="mb-4 flex justify-between md:mb-0"
                onValueChange={(value) => setGender(value)}
              >
                <div className="flex w-full items-center space-x-2 rounded py-1 md:px-5 ">
                  <RadioGroupItem
                    value="Male"
                    id="r1"
                ...
                <div className="flex w-full items-center gap-2 rounded py-1 md:px-5 ">
                  <RadioGroupItem
                    value="Female"
                    id="r2"
                    className="border-destructive"
