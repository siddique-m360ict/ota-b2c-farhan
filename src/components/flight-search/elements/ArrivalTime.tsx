...
const ArrivalTime = () => {
  ...
  return (
    <div className="grid w-full gap-4 ">
      <label className="mb-1 flex gap-8 text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
        Arrival Time
        <p>
          {range[0] < 10
      ...
      <Slider
        ...
        trackClassName="h-[1px] bg-destructive"
...
export default React.memo(ArrivalTime)
